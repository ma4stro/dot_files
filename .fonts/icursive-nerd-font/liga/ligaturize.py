...
# Example:
# ligaturize.py /path/to/font-file --family-name='Family Name' --full-name='Full Name'
...
def update_font_metadata(font, new_name, full_name):
...
def ligaturize_font(input_font_file, output_dir, ligature_font_file,
                    family_name, full_name, prefix, **kwargs):
    ...
    update_font_metadata(font, name, fname)
...
def parse_args():
    ...
    parser.add_argument("--output-dir",
        ...
        help="The directory to save the ligaturized font in. The actual filename"
             ...
             " the --prefix and --family-name flags.")
    ...
    parser.add_argument("--family-name",
        type=str, default="",
        help="Family Name of the generated font. Completely replaces the original.")
    parser.add_argument("--full-name",
        type=str, default="",
        help="Full Name of the generated font. Completely replaces the original.")
