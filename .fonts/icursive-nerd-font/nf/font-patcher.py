...
# Example: ./font-patcher.py -f "family name" -F "full name" /path/to/fontfile
...
class font_patcher:
    ...
    def setup_arguments(self):
        ...
        parser.add_argument('-s', '--mono', '--use-single-width-glyphs', dest='single',           default=True,  action='store_true', help='Whether to generate the glyphs as single-width not double-width (default is double-width)')
        parser.add_argument('-l', '--adjust-line-height',                dest='adjustLineHeight', default=True,  action='store_true', help='Whether to adjust line heights (attempt to center powerline separators more evenly)')
        ...
        parser.add_argument('-f', '--family-name',                       dest='familyname',       default="",    type=str, nargs='?', help='Change family name')
        parser.add_argument('-F', '--full-name',                         dest='fullname',         default="",    type=str, nargs='?', help='Change full name')
        parser.add_argument('-c', '--complete',                          dest='complete',         default=True,  action='store_true', help='Add all available Glyphs')
        ...
        parser.add_argument('-ext', '--extension',                       dest='extension',        default="ttf", type=str, nargs='?', help='Change font file type to create (e.g., ttf, otf)')
    ...
    def setup_font_names(self):
        ...
        if self.args.familyname:
            self.sourceFont.familyname = self.args.familyname
        if self.args.fullname:
            self.sourceFont.fullname = self.args.fullname
