...
fg_color_config_nh='@prefix_not_highlight_fg'
bg_color_config_nh='@prefix_not_highlight_bg'
...
output_prefix_not_highlight='@prefix_not_highlight_output_prefix'
output_suffix_not_highlight='@prefix_not_highlight_output_suffix'
...
default_empty_attr='fg=colour04,bg=colour234'
...
main() {
    local -r \
        ...
        fg_color_nh=$(tmux_option "$fg_color_config_nh" "$default_fg") \
        bg_color_nh=$(tmux_option "$bg_color_config_nh" "$default_bg") \
        ...
        output_prefix_not_highlight=$(tmux_option "$output_prefix_not_highlight" " ") \
        output_suffix_not_highlight=$(tmux_option "$output_suffix_not_highlight" " ") \
    ...
    local -r prefix_not_highlight="$(format_style "fg=$fg_color_nh,bg=$bg_color_nh")"
    local -r prefix_mode="$prefix_highlight$output_prefix$prefix_prompt$output_suffix"

    #local -r prefix_mode_nh="$prefix_not_highlight$output_prefix$prefix_prompt$output_suffix"
    ...
    if [[ "on" = "$empty_has_affixes" ]]; then
        local -r empty_mode="$prefix_not_highlight$output_prefix_not_highlight$prefix_prompt$output_suffix_not_highlight"
    else
